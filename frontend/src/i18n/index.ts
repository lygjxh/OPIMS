...
const messages = {
  zh: {
    ...
    menu: {
      ...
      progressRadar: '时限雷达',
      progressCheck: '月度报送',
      progressIndicators: '进度指标',
      progressDeviation: '偏差与纠偏',
      progressEot: '工期索赔',
      progressPlan: '计划与考核',
      archive: '收文归档',
      quality: '质量管理',
  ...
  en: {
    ...
    menu: {
      ...
      progress: 'Progress',
      progressRadar: 'Time Bar Radar',
      progressCheck: 'Monthly Submission',
      progressIndicators: 'Indicators',
      progressDeviation: 'Deviation & Recovery',
      progressEot: 'EOT Claims',
      progressPlan: 'Planning & Appraisal',
